...
class KmController {
    ...
    public async chartsPage(req: Request, res: Response) {
        ...
        const countData = await dao.countData();
    ...
    public async chartData(req: Request, res: Response) {
        ...
        const response = await dao.getData(x, y);
    ...
    public async saveData(req: Request, res: Response) {
        ...
        try {
            ...
            // guardar datos en BD
            const response = await dao.saveData(signo, genero, edad, sueldo, parejas);
...
export const kmController = new KmController();